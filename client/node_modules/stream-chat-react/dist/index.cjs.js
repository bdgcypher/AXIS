...
var Listener = function Listener() {
  ...
  _defineProperty__default['default'](this, "remove", function (ids) {
...
var ReactTextareaAutocomplete = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactTextareaAutocomplete(_props) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "addKeycodeSubmitListeners", function (keyCodes) {
...
var useEmojiTrigger = function (emojiIndex) { return ({
...
var CooldownTimer = function (props) {
            ...
            React__default['default'].createElement("div", { className: "str-chat__small-message-input " + (SendButton$1 ? 'str-chat__small-message-input--send-button-active' : null) },
                React__default['default'].createElement("div", { className: 'str-chat__small-message-input--textarea-wrapper' },
                    ...
                    cooldownRemaining ? (React__default['default'].createElement("div", { className: 'str-chat__input-small-cooldown' },
                        React__default['default'].createElement(CooldownTimer$1, { cooldownInterval: cooldownInterval, setCooldownRemaining: setCooldownRemaining }))) : (React__default['default'].createElement(React__default['default'].Fragment, null,
                        isUploadEnabled && (React__default['default'].createElement("div", { className: 'str-chat__fileupload-wrapper', "data-testid": 'fileinput' },
                            React__default['default'].createElement(Tooltip, null, maxFilesLeft
                                ? t('Attach files')
                                : t("You've reached the maximum number of files")),
...
var moveChannelUp = function (_a) {
    ...
    return uniqBy__default['default'](__spreadArray([channel], channels), 'cid');
};
...
var MessageLivestream = function (props) {
    ...
    return (React__default['default'].createElement(MemoizedMessageLivestream, __assign({}, messageContext, { isReactionEnabled: isReactionEnabled, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions }, props)));
};
...
var MessageTeam = function (props) {
    ...
    var message = props.message || messageContext.message;
    var _a = useReactionClick(message, reactionSelectorRef, messageWrapperRef), isReactionEnabled = _a.isReactionEnabled, onReactionListClick = _a.onReactionListClick, showDetailedReactions = _a.showDetailedReactions;
    return (React__default['default'].createElement(MemoizedMessageTeam, __assign({}, messageContext, { isReactionEnabled: isReactionEnabled, messageWrapperRef: messageWrapperRef, onReactionListClick: onReactionListClick, reactionSelectorRef: reactionSelectorRef, showDetailedReactions: showDetailedReactions }, props)));
};
...
var useCallLoadMore = function (loadMore, limit) {
...
var MessageList = function (props) {
    ...
    return (React__default['default'].createElement(MessageListWithContext, __assign({ loadMore: loadMore }, restChannelStateContext, props)));
};
...
var ThreadInner = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: threadClass + " " + (fullWidth ? 'str-chat__thread--full' : '') },
        ...
        React__default['default'].createElement("div", { className: 'str-chat__thread-list', ref: messageList },
            ...
            React__default['default'].createElement(ThreadMessageList, __assign({ hasMore: threadHasMore, loadingMore: threadLoadingMore, loadMore: loadMoreThread, Message: ThreadMessage || FallbackMessage, messages: threadMessages || [], threadList: true }, (virtualized ? additionalVirtualizedMessageListProps : additionalMessageListProps)))),
...
exports.useCallLoadMore = useCallLoadMore;
